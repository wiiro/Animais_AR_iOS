...
namespace Recorder
{
    public class ScreenRecorder : MonoBehaviour
    {
        ...
        public string FilePath = GALLERY_PATH;
    ...
    androidRecorder.Call("stopRecording");
        ...
        string fileName = "Video_" + now.Year + "_" + now.Month + "_" + now.Day + "_" + now.Hour + "_" + now.Minute + "_" + ".mp4";
        ...
        System.IO.File.Copy(Application.persistentDataPath + "/" + VIDEO_NAME + ".mp4", Application.persistentDataPath + "/" + fileName);
